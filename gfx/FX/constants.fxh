...
static const float  SHADOW_WEIGHT_TREE   		= 10000.0f;
...
static const float GB_THRESHOLD2 = 0.175f; // interpolation time
...
static const float GB_OPACITY_NEAR = 0.85f; // Transparency when camera is near
static const float GB_OPACITY_FAR = 0.975f;  // Transparency when camera is far
